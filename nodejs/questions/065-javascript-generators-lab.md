...
- **#65** in the Codedamn Node.js list
- **Difficulty:** Medium
- **Source:** https://codedamn.com/problem/yKLFVto35u2-Zs4PUWNs4
- **Starter repo:** https://github.com/mehulmpt/web-development-labs (branch `lab_1683289860`)
...
If you've never heard of Generators, go through the [Documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Generator) to understand the basic usage of Generators
