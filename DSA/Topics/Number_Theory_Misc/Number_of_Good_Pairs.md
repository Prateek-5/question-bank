...
**In plain words:** For each value of count c, pairs = C(c,2).
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: For each value of count c, pairs = C(c,2).
...
**The concept:** For each value of count c, pairs = C(c,2).
