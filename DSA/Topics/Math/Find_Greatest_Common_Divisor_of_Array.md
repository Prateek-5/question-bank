...
**In plain words:** GCD(min, max) — GCD of array equals GCD of its smallest and largest elements only *if* the array is specified that way; generally you iterate.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: GCD(min, max) — GCD of array equals GCD of its smallest and largest elements only *if* the array is specified that way; generally you iterate.
...
**The concept:** GCD(min, max) — GCD of array equals GCD of its smallest and largest elements only *if* the array is specified that way; generally you iterate.
