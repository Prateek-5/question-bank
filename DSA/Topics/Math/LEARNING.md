...
1. **[Add_Digits.md](./Add_Digits.md)**  ·  [walkthrough →](./learn/Add_Digits.md) — Digital root; closed-form `1 + (n-1) % 9`. **must-do** (the closed form is the senior signal)
2. **[Determine_Color_of_a_Chessboard_Square.md](./Determine_Color_of_a_Chessboard_Square.md)**  ·  [walkthrough →](./learn/Determine_Color_of_a_Chessboard_Square.md) — Parity of row + column.
3. **[Day_of_the_Week.md](./Day_of_the_Week.md)**  ·  [walkthrough →](./learn/Day_of_the_Week.md) — Zeller's congruence or counted-days reference.

### Arithmetic sequences

4. **[Count_of_Matches_in_Tournament.md](./Count_of_Matches_in_Tournament.md)**  ·  [walkthrough →](./learn/Count_of_Matches_in_Tournament.md) — Each match eliminates one team → `n - 1`. Closed form > simulation.
5. **[Find_the_Pivot_Integer.md](./Find_the_Pivot_Integer.md)**  ·  [walkthrough →](./learn/Find_the_Pivot_Integer.md) — Sum-of-1-to-n; algebra over loop.

### GCD / divisibility

6. **[Find_Greatest_Common_Divisor_of_Array.md](./Find_Greatest_Common_Divisor_of_Array.md)**  ·  [walkthrough →](./learn/Find_Greatest_Common_Divisor_of_Array.md) — `gcd(min, max)`. Know Euclid's algorithm. **must-do**
7. **[Subarray_Sums_Divisible_by_K.md](./Subarray_Sums_Divisible_by_K.md)**  ·  [walkthrough →](./learn/Subarray_Sums_Divisible_by_K.md) — Prefix sum mod K; hash. Bridges Math into Hashing. **must-do**
