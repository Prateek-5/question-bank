...
**In plain words:** Single-elimination: total matches = n - 1.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Single-elimination: total matches = n - 1.
...
**The concept:** Single-elimination: total matches = n - 1.
