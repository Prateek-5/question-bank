...
**In plain words:** Simplify |a|+|b|+|c| over four sign combinations; scan with prefix maxima/minima.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Simplify |a|+|b|+|c| over four sign combinations; scan with prefix maxima/minima.
...
**The concept:** Simplify |a|+|b|+|c| over four sign combinations; scan with prefix maxima/minima.
