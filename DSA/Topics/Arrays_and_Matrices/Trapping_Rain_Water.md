...
**In plain words:** Two-pointer sweep comparing left_max and right_max.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Two-pointer sweep comparing left_max and right_max.
...
**The concept:** Two-pointer sweep comparing left_max and right_max.
