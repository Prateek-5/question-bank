...
**In plain words:** Greedy running-tank: if total gas ≥ total cost, starting station is the one after the last negative prefix.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Greedy running-tank: if total gas ≥ total cost, starting station is the one after the last negative prefix.
...
**The concept:** Greedy running-tank: if total gas ≥ total cost, starting station is the one after the last negative prefix.
