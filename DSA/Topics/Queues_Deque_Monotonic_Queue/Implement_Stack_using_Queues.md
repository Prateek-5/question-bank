...
**In plain words:** Two queues or one-queue rotation.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Two queues or one-queue rotation.
...
**The concept:** Two queues or one-queue rotation.
