...
**In plain words:** Sort; pair smallest with largest, etc.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Sort; pair smallest with largest, etc.
...
**The concept:** Sort; pair smallest with largest, etc.
