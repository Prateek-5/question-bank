...
**In plain words:** Sort + fix first + two-pointer on remaining.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Sort + fix first + two-pointer on remaining.
...
**The concept:** Sort + fix first + two-pointer on remaining.
