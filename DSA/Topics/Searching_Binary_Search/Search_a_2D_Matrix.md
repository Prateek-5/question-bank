...
**In plain words:** Treat matrix as flat sorted array; binary search on n*m length.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Treat matrix as flat sorted array; binary search on n*m length.
...
**The concept:** Treat matrix as flat sorted array; binary search on n*m length.
