...
**In plain words:** Greedy two-pointer — pair smallest sufficient cookie with smallest greed.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Greedy two-pointer — pair smallest sufficient cookie with smallest greed.
...
**The concept:** Greedy two-pointer — pair smallest sufficient cookie with smallest greed.
