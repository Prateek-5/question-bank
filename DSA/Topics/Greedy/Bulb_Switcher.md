...
**In plain words:** Perfect-square observation — bulbs toggled an odd number of times remain on.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Perfect-square observation — bulbs toggled an odd number of times remain on.
...
**The concept:** Perfect-square observation — bulbs toggled an odd number of times remain on.
