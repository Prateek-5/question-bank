...
**In plain words:** Index mapping i → (i/n, i%n).
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Index mapping i → (i/n, i%n).
...
**The concept:** Index mapping i → (i/n, i%n).
