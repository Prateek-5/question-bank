...
**In plain words:** Contribution counting: each element appears in a known number of odd-length subarrays.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Contribution counting: each element appears in a known number of odd-length subarrays.
...
**The concept:** Contribution counting: each element appears in a known number of odd-length subarrays.
