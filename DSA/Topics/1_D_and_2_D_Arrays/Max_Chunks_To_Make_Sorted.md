...
**In plain words:** Count indices where running max equals current index.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Count indices where running max equals current index.
...
**The concept:** Count indices where running max equals current index.
