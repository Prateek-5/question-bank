...
**In plain words:** Min-heap over the heads of each list.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Min-heap over the heads of each list.
...
**The concept:** Min-heap over the heads of each list.
