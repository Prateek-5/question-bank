...
**In plain words:** Two heaps: max-heap for lower half, min-heap for upper half.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Two heaps: max-heap for lower half, min-heap for upper half.
...
**The concept:** Two heaps: max-heap for lower half, min-heap for upper half.
