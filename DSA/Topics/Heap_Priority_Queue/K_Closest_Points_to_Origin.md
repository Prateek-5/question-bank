...
**In plain words:** Max-heap of size k keyed by squared distance — keeps k smallest.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Max-heap of size k keyed by squared distance — keeps k smallest.
...
**The concept:** Max-heap of size k keyed by squared distance — keeps k smallest.
