...
**In plain words:** Topological sort via Kahn's algorithm (BFS on in-degree).
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Topological sort via Kahn's algorithm (BFS on in-degree).
...
**The concept:** Topological sort via Kahn's algorithm (BFS on in-degree).
