...
**In plain words:** Flood-fill from boundary Os to identify safe ones; flip the rest.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Flood-fill from boundary Os to identify safe ones; flip the rest.
...
**The concept:** Flood-fill from boundary Os to identify safe ones; flip the rest.
