...
**In plain words:** BFS in 8-directional grid.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: BFS in 8-directional grid.
...
**The concept:** BFS in 8-directional grid.
