...
**In plain words:** BFS over remainders mod n with digits 0 and 1.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: BFS over remainders mod n with digits 0 and 1.
...
**The concept:** BFS over remainders mod n with digits 0 and 1.
