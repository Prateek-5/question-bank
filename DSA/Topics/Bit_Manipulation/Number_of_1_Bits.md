...
**In plain words:** Bit trick — n & (n-1) clears lowest set bit.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Bit trick — n & (n-1) clears lowest set bit.
...
**The concept:** Bit trick — n & (n-1) clears lowest set bit.
