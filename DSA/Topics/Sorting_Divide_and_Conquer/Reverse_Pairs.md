...
**In plain words:** Merge sort counting pairs (i,j) with i<j and nums[i] > 2·nums[j].
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Merge sort counting pairs (i,j) with i<j and nums[i] > 2·nums[j].
...
**The concept:** Merge sort counting pairs (i,j) with i<j and nums[i] > 2·nums[j].
