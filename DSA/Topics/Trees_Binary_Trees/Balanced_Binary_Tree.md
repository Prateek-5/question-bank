...
**In plain words:** Post-order DFS returning height, propagating -1 on imbalance.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Post-order DFS returning height, propagating -1 on imbalance.
...
**The concept:** Post-order DFS returning height, propagating -1 on imbalance.
