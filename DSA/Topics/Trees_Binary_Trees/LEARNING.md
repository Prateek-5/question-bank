...
1. **[Binary_Tree_Preorder_Traversal.md](./Binary_Tree_Preorder_Traversal.md)** — Visit, left, right. **must-do**
2. **[Binary_Tree_Inorder_Traversal.md](./Binary_Tree_Inorder_Traversal.md)** — Left, visit, right. Sorted on BSTs. **must-do**
3. **[Binary_Tree_Postorder_Traversal.md](./Binary_Tree_Postorder_Traversal.md)** — Left, right, visit. **must-do**
4. **[Binary_Tree_Inorder_Traversal_Iterative.md](./Binary_Tree_Inorder_Traversal_Iterative.md)** — Explicit stack; the "leftmost-first" pattern. **must-do**
5. **[Binary_Tree_Level_Order_Traversal.md](./Binary_Tree_Level_Order_Traversal.md)** — BFS with queue; snapshot per level. **must-do**

### Structural / property

6. **[Maximum_Depth_of_Binary_Tree.md](./Maximum_Depth_of_Binary_Tree.md)** — `1 + max(left, right)`. **must-do**
7. **[Balanced_Binary_Tree.md](./Balanced_Binary_Tree.md)** — Post-order returns height OR `-1` if unbalanced. The "encode invalid as -1" trick. **must-do**

### Single-node ops

8. **[Invert_Binary_Tree.md](./Invert_Binary_Tree.md)** — Swap left/right, recurse. The Homebrew problem.

### Path-sum family

9. **[Path_Sum.md](./Path_Sum.md)** — Exists root-to-leaf with target sum? **must-do**
10. **[Path_Sum_II.md](./Path_Sum_II.md)** — Collect all such paths. Backtracking on tree.
11. **[Path_Sum_III.md](./Path_Sum_III.md)** — Any path (not necessarily root-leaf). Prefix-sum + hash. **must-do**
12. **[Paths_from_root_with_a_specified_sum.md](./Paths_from_root_with_a_specified_sum.md)** — Companion variant.
13. **[Sum_Root_to_Leaf_Numbers.md](./Sum_Root_to_Leaf_Numbers.md)** — Accumulate `10 * acc + node.val`.

### LCA + Construction

14. **[Lowest_Common_Ancestor_of_Binary_Tree.md](./Lowest_Common_Ancestor_of_Binary_Tree.md)** — Recursive: if both children find something, current is LCA. **must-do**
15. **[Construct_Binary_Tree_from_Inorder_and_Postorder.md](./Construct_Binary_Tree_from_Inorder_and_Postorder.md)** — Last of postorder is root; split inorder by it; recurse.
