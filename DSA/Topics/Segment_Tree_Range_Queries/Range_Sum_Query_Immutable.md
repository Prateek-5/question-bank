...
**In plain words:** Prefix sums for O(1) range sum queries.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Prefix sums for O(1) range sum queries.
...
**The concept:** Prefix sums for O(1) range sum queries.
