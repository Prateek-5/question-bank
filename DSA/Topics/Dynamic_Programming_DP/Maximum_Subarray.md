...
**In plain words:** Kadane's algorithm — running-sum reset.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Kadane's algorithm — running-sum reset.
...
**The concept:** Kadane's algorithm — running-sum reset.
