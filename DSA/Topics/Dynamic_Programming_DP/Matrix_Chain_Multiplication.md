...
**In plain words:** Interval DP over splitting index.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Interval DP over splitting index.
...
**The concept:** Interval DP over splitting index.
