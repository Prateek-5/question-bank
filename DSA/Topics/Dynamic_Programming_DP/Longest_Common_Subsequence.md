...
**In plain words:** Classic 2D DP over (i,j).
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Classic 2D DP over (i,j).
...
**The concept:** Classic 2D DP over (i,j).
