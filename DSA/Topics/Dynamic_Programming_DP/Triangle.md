...
**In plain words:** Bottom-up DP on rows.
...
- **What am I being asked to optimize, count, or find?** In this case, we're focused on: Bottom-up DP on rows.
...
**The concept:** Bottom-up DP on rows.
